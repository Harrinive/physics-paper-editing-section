...
**For agents:** Start with the skill that matches scope — micro [physics-paper-editing/SKILL.md](../physics-paper-editing/SKILL.md) § Agent read order for ≤12 sentences; this parent [SKILL.md](SKILL.md) § Agent read order for whole sections. Read this file only when routing, resuming, or handing off verifier models between parent and micro.

**Audience:** section orchestrator · micro agents **invoked from Stage D** · skill maintainers.

**Do not read this file** for a standalone short-passage edit (≤12 sentences, only the micro skill attached). That path is fully specified in [physics-paper-editing/SKILL.md](../physics-paper-editing/SKILL.md) plus [coworker-loop.md](../physics-paper-editing/coworker-loop.md).
...
| Skill | Path | Scope |
|-------|------|-------|
| **Principles** | [physics-paper-principles/SKILL.md](../physics-paper-principles/SKILL.md) | What the prose should be |
| **Micro** | [physics-paper-editing/SKILL.md](../physics-paper-editing/SKILL.md) | One passage **≤12 sentences** — coworker loop |
| **Macro (parent)** | [SKILL.md](SKILL.md) | Whole `\section{...}` or **>12 sentences** |

Standalone micro needs only one fact about the parent: **if the quote exceeds 12 sentences, stop** and suggest this skill or ask the user to narrow — [physics-paper-editing/SKILL.md](../physics-paper-editing/SKILL.md) § Scope overflow.
...
**Micro gate canonical:** [gate.md](../physics-paper-editing/gate.md) § Sentence-count thresholds.
...
2. Inherit pace + the three slugs from this chat, **or** use recommended defaults and mention once ([user-communication.md](../physics-paper-editing/user-communication.md)).
...
|-------|----------------|---------|
| Sentence / narrative / math principles | [physics-paper-principles](../physics-paper-principles/SKILL.md) | Layer files |
| Physical lead | [physical-lead.md](../physics-paper-principles/physical-lead.md) | Full file |
| Severity / BLOCKER lists | [severity.md](../physics-paper-editing/severity.md) | Full file |
| Coworker loop | [coworker-loop.md](../physics-paper-editing/coworker-loop.md) | Full file |
| Marks / snapshot / interrupt | [job-state.md](../physics-paper-editing/job-state.md) | Full file |
| Merge | [merge-policy.md](../physics-paper-editing/merge-policy.md) | Full file |
