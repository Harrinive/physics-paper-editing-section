...
**For agents:** Start with [LEGACY.md](LEGACY.md) § Agent read order. **Read with the Read tool** for Stages B and E.

Section-scoped review uses **`physics-paper-principles`** **verbatim**:

- [narrative.md](../../physics-paper-principles/legacy-v1/narrative.md)
- [math.md](../../physics-paper-principles/legacy-v1/math.md)
- named objects: [physical-lead.md](../../physics-paper-principles/legacy-v1/physical-lead.md)

Severity mapping (BLOCKER vs SUGGEST) is [severity.md](../../physics-paper-editing/legacy-v1/severity.md). Do **not** fork those files. This skill adds a **`Scope:` header** so verifiers know which unit "the whole" refers to (the narrative file already supports section scale).
...
## Instructions
Read ../../physics-paper-principles/legacy-v1/narrative.md (Read tool). Run every group and bullet.
...
## Instructions
Read ../../physics-paper-principles/legacy-v1/math.md (Read tool). Run Step 0, then type-specific checks.
...
Emit `<!-- SECTION DONE ... -->` per [LEGACY.md](LEGACY.md) § Response format.
