...
**For agents:** Start with [LEGACY.md](LEGACY.md) § Agent read order. This file is canonical for Stages A–E step detail.

**Read with the Read tool** when running the macro pipeline ([LEGACY.md](LEGACY.md)). Micro handoff per chunk: [chunk-contract.md](chunk-contract.md) · shared rules: [cross-skill.md](cross-skill.md). User-facing copy: [user-communication.md](../../physics-paper-editing/legacy-v1/user-communication.md).
...
4. Ask polish/rewrite/mixed only if unclear. Inherit pace + models when
   ...
   mention once ([user-communication.md](../../physics-paper-editing/legacy-v1/user-communication.md)).
...
Section-scoped verifiers may run asynchronously ([scope-and-verifiers.md](scope-and-verifiers.md), [coworker-loop.md](../../physics-paper-editing/legacy-v1/coworker-loop.md) harvest rules). Structure-only writes do not wait for those verifier jobs if the moves are already clear; still persist findings in `findings-ledger.md`.
...
Use the same feasibility rules as the micro gate ([gate.md](../../physics-paper-editing/legacy-v1/gate.md)).
