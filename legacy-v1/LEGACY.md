...
| **Stage D (per chunk)** | micro [SKILL.md](../../physics-paper-editing/legacy-v1/LEGACY.md) — coworker loop on `chunk_text` only |
| **Every user-facing turn** | [user-communication.md](../../physics-paper-editing/legacy-v1/user-communication.md) |
...
- User-facing copy: [user-communication.md](../../physics-paper-editing/legacy-v1/user-communication.md). Do not say “reply continue.”

## Response format

Follow [user-communication.md](../../physics-paper-editing/legacy-v1/user-communication.md).
...
| [coworker-loop.md](../../physics-paper-editing/legacy-v1/coworker-loop.md) | Draft-first loop |
| [user-communication.md](../../physics-paper-editing/legacy-v1/user-communication.md) | Workbench UX |
| [../../physics-paper-principles/legacy-v1/LEGACY.md](../../physics-paper-principles/legacy-v1/LEGACY.md) | Prose canon |
